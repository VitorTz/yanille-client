...
export class TagService {
    ...
    async getUserTags(limit: number = 64, offset: number = 0): Promise<Pagination<UrlTag>> {
       try {
         const response = await this.client.get<Pagination<UrlTag>>('/user/tags/', {
           params: { limit, offset },
         });
    ...
    async createTag(data: UrlTagCreate): Promise<UrlTag> {
       try {
         const response = await this.client.post<UrlTag>('/user/tags/', data);
         return response.data;
       } catch (error) {
         throw error;
       }
    ...
    async updateTag(data: UrlTagUpdate): Promise<UrlTag> {
       try {
         const response = await this.client.put<UrlTag>('/user/tags/', data);
         return response.data;
       } catch (error) {
         throw error;
       }
    ...
    async deleteTag(id: number): Promise<void> {
       try {
         await this.client.delete('/user/tags/', {
           data: { id },
         });
       } catch (error) {
         throw error;
    ...
    async getUrlsFromTag(tagId: number, limit: number = 64, offset: number = 0): Promise<Pagination<URLResponse>> {
       try {
         const response = await this.client.get<Pagination<URLResponse>>('/user/tags/relations', {
    ...
    async createUrlTagRelation(urlId: number, tagId: number): Promise<void> {
       try {
         await this.client.post('/user/tags/relations', {
           url_id: urlId,
           tag_id: tagId,
         });
       } catch (error) {
    ...
    async deleteUrlTagRelation(urlId: number, tagId: number): Promise<void> {
       try {
         await this.client.delete('/user/tags/relations', {
           data: {
             url_id: urlId,
             tag_id: tagId,
           },
    ...
    async clearTag(tagId: number): Promise<void> {
       try {
         await this.client.delete('/user/tags/relations/clear', {
           data: { id: tagId },
         });
       } catch (error) {
         throw error;
